...
class IngTableViewController: UITableViewController {
    ...
    var titles:[String] = ["제1강. 중국어 3달만에 귀가 트이는 법",
                           "제1강. 스페인여행 기초회화",
                           "제1강. 너도 영어할래?",
                           "제3강. 펀드, 모른다면 이것만 해라!",
                           "제2강. 부동산을 팔고 금을 사라",
                           ...
                           "제1강. AWS클라우드 이해하기",
                           "제2강. AWS클라우드 이해하기"]
    var imgurls:[URL] = [URL(string: "https://shinpleios.s3.us-east-2.amazonaws.com/Language/Chinese/image/Chap1.png")!,
    ...
    var videoRates:[Float] = [0.2, 0.1, 0.5, 0.1, 0.3, 0.4, 0.7, 0.8]
    var contents:[String] = ["C 언어를 처음 시작하는 출발선은 같지만 C 언어 문법 하나하나가",
                             ...
                             "자격증을 공부하는 모든 예비 전문가들에게 쉽고 빠르게",
                             "가장 강력한 클라우드 서비스를 경험하기 위한 최고의 AWS 가이드클라우드",
                             "AWS 서비스를 잘 활용해 실전에서 바로 서비스를 운영"]
    var videoTimes:[Int] = [5513, 3520, 1511, 90132, 1300, 1511, 9032, 1300]
    var favorites:[Bool] = [false, false, true, false, true, true, true, false]
